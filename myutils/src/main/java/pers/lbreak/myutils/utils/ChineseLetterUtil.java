...
//        String firstLetter = ChineseLetterUtil.getFirstLetter("张三");
//        System.out.println(firstLetter);
//    }
    private final static ChineseLetterUtil utils=new ChineseLetterUtil();
    private ChineseLetterUtil(){
    }
    public static ChineseLetterUtil getInstance(){
        return utils;
    }
